...
let sampleVendors: [Vendor] = [
    Vendor(name: "Wattpad", logoName: "wattpad", rating: 4, category: "Books"),
    Vendor(name: "Kuromi", logoName: "kuromi", rating: 5, category: "Stationery"),
    Vendor(name: "Crane & Co", logoName: "crane", rating: 5, category: "Stationery"),
    Vendor(name: "GooDay", logoName: "gooday", rating: 5, category: "Books"),
    Vendor(name: "Warehouse", logoName: "warehouse", rating: 5, category: "Stationery"),
    Vendor(name: "Peppa Pig", logoName: "peppa", rating: 5, category: "Books"),
    Vendor(name: "Jstor", logoName: "jstor", rating: 5, category: "Poems"),
    ...
    Vendor(name: "Staedtler", logoName: "staedtler", rating: 5, category: "Stationery"),
    ...
    Vendor(name: "Scribner", logoName: "scribner", rating: 5, category: "Books"),
